...
def user_permissions(request):
    ...
    permissions = {
        ...
        # FF-Verwaltung: Einheitsführer, Vertreter, FF Verwalter (per Recht)
        'is_ff_leader': request.user.has_perm('personnel.manage_ff_person'),
    }
    ...
    try:
        ...
        return {
            'modules': {
                ...
                'dienstplan_enabled': sys_settings.dienstplan_enabled,
                'termine_enabled': sys_settings.termine_enabled,
        ...
        return {
            'modules': {
                ...
                'iuk_enabled': False,
                'dienstplan_enabled': False,
                'termine_enabled': False,
